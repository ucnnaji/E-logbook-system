      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
          		...
          		<div class="col-lg-12">
 <?php
$q = "SELECT id, user_level, name, matric, email, pnum, start_date, end_date, supervisor, company, image, password, date FROM users WHERE user_level=1 ORDER BY date DESC";
...
<br>
                                ...
                                <a href="report?id='.$row['id'].'"><button class="btn btn-small btn-theme03">REPORT</button></a>
							</div>
						</div>
                      ';
 }
