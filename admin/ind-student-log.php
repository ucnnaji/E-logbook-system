...
echo'
                                  ...
                                  <td>
                                  <a href="ind-action?id='.$row['id'].'&id2='.$id.'&action=approve"><button class="btn btn-success btn-xs"><i class="fa fa-check"></i> Approve</button></a>
                                  <a href="ind-action?id='.$row['id'].'&id2='.$id.'&action=disapprove"><button class="btn btn-danger btn-xs"><i class="fa fa-cancle"></i> Disapprove</button></a>
                                  </td>
                              </tr>
