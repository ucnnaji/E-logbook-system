...
/*  $image = $_FILES['image']['name'];
 ...
 VALUES ('0', '$email', '$name', '$email', '$pnum', '$institution', '$pass',  NOW() )";
   $result = @mysqli_query ($dbcon, $q);
      $q = "INSERT INTO supervisors (level, name, email, pnum, company_school, password, date)
 VALUES ('0', '$name', '$email', '$pnum', '$institution', '$pass',  NOW() )";
   $result = @mysqli_query ($dbcon, $q);
          ...
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-plus"></i> Add Industrial Supervisor</h4>
                      <form class="form-horizontal style-form" method="post" action="add_ind_supervisor" enctype="multipart/form-data">
